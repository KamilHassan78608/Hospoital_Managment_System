...
public class viewDoc extends JFrame{
    ...
    private void getData(int i){
        ...
        try (Connection conn = DBConnection.connect()) {
            String sql1 = "SELECT Name FROM Doctor WHERE id = ?";
            String sql2 = "SELECT Specialization FROM Doctor WHERE id = ?";
            String sql3 = "SELECT Contact FROM Doctor WHERE id = ?";
            String sql4 = "SELECT Gender FROM Doctor WHERE id = ?";
            String sql5 = "SELECT Salary FROM Doctor WHERE id = ?";
            ...
            if (rs5.next()) {
                String name = rs5.getString("Salary");
                passwordLabel.setText(""+name);
                System.out.println(name);
            }else{
                passwordLabel.setText("Salary Not Found");
            }
        } catch (Exception e) {
